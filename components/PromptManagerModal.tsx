        ...
        <div className="flex-grow flex min-h-0">
          ...
          <div className="w-1/3 border-r border-gray-700 flex flex-col">
            ...
            <div className="p-3 border-t border-gray-700">
                <button onClick={handleNewPrompt} className="w-full flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-500 text-white font-bold py-2 px-4 rounded-lg transition-colors">
