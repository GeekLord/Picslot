...
export const CompCardIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25H12" />
    </svg>
);

export const ThreeViewIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 0 0 2.625.372 9.337 9.337 0 0 0 4.121-.952 4.125 4.125 0 0 0-7.53-2.475c3.436-.213 6.54-1.6 8.37-3.921-.252-2.115-1.34-4.01-3.04-5.464a4.125 4.125 0 0 0-7.53 2.475c-1.353.36-2.61.94-3.684 1.74a4.125 4.125 0 0 0-7.53-2.475c-3.436.213-6.54 1.6-8.37 3.921.252 2.115 1.34 4.01 3.04 5.464a4.125 4.125 0 0 0 7.53-2.475Z" />
    </svg>
);

export const ChangeViewIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 3.75c-3.134 0-5.833 4.133-5.833 9.167s2.699 9.167 5.833 9.167c3.134 0 5.833-4.133 5.833-9.167S15.134 3.75 12 3.75Z" />
...
export const LayoutGridIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6A2.25 2.25 0 0 1 6 3.75h2.25A2.25 2.25 0 0 1 10.5 6v2.25a2.25 2.25 0 0 1-2.25 2.25H6A2.25 2.25 0 0 1 3.75 8.25V6ZM3.75 15.75A2.25 2.25 0 0 1 6 13.5h2.25a2.25 2.25 0 0 1 2.25 2.25v2.25A2.25 2.25 0 0 1 8.25 20.25H6A2.25 2.25 0 0 1 3.75 18v-2.25ZM13.5 6a2.25 2.25 0 0 1 2.25-2.25H18A2.25 2.25 0 0 1 20.25 6v2.25A2.25 2.25 0 0 1 18 10.5h-2.25A2.25 2.25 0 0 1 13.5 8.25V6ZM13.5 15.75a2.25 2.25 0 0 1 2.25-2.25H18A2.25 2.25 0 0 1 20.25 15.75v2.25A2.25 2.25 0 0 1 18 20.25h-2.25A2.25 2.25 0 0 1 13.5 18v-2.25Z" />
    </svg>
);
...
export const Cog6ToothIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M10.343 3.94c.09-.542.56-1.007 1.11-1.11a12.001 12.001 0 0 1 5.052 0c.55.103 1.02.568 1.11 1.11a12.001 12.001 0 0 1 0 5.052c-.103.55-.568 1.02-1.11 1.11a12.001 12.001 0 0 1-5.052 0c-.55-.103-1.02-.568-1.11-1.11a12.001 12.001 0 0 1 0-5.052ZM12 9.75a2.25 2.25 0 1 0 0 4.5 2.25 2.25 0 0 0 0-4.5ZM21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
  </svg>
);
...
export const RectangleStackIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M6.429 9.75 2.25 12l4.179 2.25m0-4.5 5.571 3 5.571-3m-11.142 0L12 15.25l5.571-3m-5.571 0V4.5m0 10.75v3.75m0-3.75L6.429 9.75l5.571-3 5.571 3L12 15.25l-5.571-3Z" />
    </svg>
);
...
export const SwatchIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="m14.25 9.75 4.802-4.802a3.75 3.75 0 0 0-5.304-5.304L9.75 4.5" />
    </svg>
);
...
export const TicketIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 6v.75m0 3v.75m0 3v.75m0 3V18m-9-1.5h5.25m-5.25 0h3m-3 0h-3m-2.25-4.5h16.5M5.25 6H9m-3.75 0v.75m0-3v-2.25m13.5 0v2.25m0-2.25v-2.25m0 2.25v3.75m-13.5-3.75v3.75m-3.75 0h16.5m-16.5 0h16.5" />
    </svg>
);
...
export const UsersIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.742-.586 9.094 9.094 0 0 0-1.28-4.331 9.094 9.094 0 0 0-4.062-3.535M12 18.72a9.094 9.094 0 0 1-3.742-.586 9.094 9.094 0 0 1 1.28-4.331 9.094 9.094 0 0 1 4.062-3.535m0 8.452a9.094 9.094 0 0 0-4.28-1.332 9.094 9.094 0 0 0-4.062 3.535 9.094 9.094 0 0 0 1.28 4.331 9.094 9.094 0 0 0 3.742.586M12 18.72a9.094 9.094 0 0 0 4.28-1.332 9.094 9.094 0 0 0 4.062 3.535 9.094 9.094 0 0 0-1.28 4.331 9.094 9.094 0 0 0-3.742.586M9 9.75a3 3 0 1 1 6 0 3 3 0 0 1-6 0Zm0 0A2.25 2.25 0 0 0 6.75 12v.25a.75.75 0 0 0 1.5 0v-.25A2.25 2.25 0 0 0 9 9.75Zm6 0a2.25 2.25 0 0 1 2.25 2.25v.25a.75.75 0 0 1-1.5 0v-.25A2.25 2.25 0 0 1 15 9.75Z" />
  </svg>
);

export const ChartBarIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75c0 .621-.504 1.125-1.125 1.125h-2.25A1.125 1.125 0 0 1 3 21v-7.875M12.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v12.375c0 .621-.504 1.125-1.125 1.125h-2.25A1.125 1.125 0 0 1 12.75 21V8.625M20.25 18c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v3.375c0 .621-.504 1.125-1.125 1.125h-2.25A1.125 1.125 0 0 1 20.25 21v-3Z" />
  </svg>
);